...
---
= Verificação do conteúdo do arquivo Disk.RAW e do arquivo digest usando OpenSSL
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Os comandos OpenSSL para validar a imagem são compatíveis com máquinas Linux, Mac os e Windows.
