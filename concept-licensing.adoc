...
Inscrição no Keystone:: Um serviço baseado em subscrição com pagamento conforme o uso que proporciona uma experiência otimizada de nuvem híbrida para pares de HA.
...
Pague por capacidade pelo Cloud Volumes ONTAP em várias configurações diferentes.
...
IMPORTANT: O NetApp irá descontinuar o licenciamento baseado em nó em breve, que será substituído por licenças baseadas em capacidade. Para obter informações, https://mysupport.netapp.com/info/communications/CPC-00589.html["Comunicado do cliente: CPC-00589"^] consulte .
