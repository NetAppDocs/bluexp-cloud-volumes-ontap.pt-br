...
.. Na janela Excluir ambiente de trabalho, digite o nome do ambiente de trabalho e clique em *Excluir*.  Pode levar até cinco minutos para excluir o ambiente de trabalho.
