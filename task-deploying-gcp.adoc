...
+
Para obter mais informações, link:task-planning-your-config-gcp.html#choose-a-volume-usage-profile["Escolha um perfil de uso de volume"^]consulte e link:concept-data-tiering.html["Visão geral de categorização de dados"^].
