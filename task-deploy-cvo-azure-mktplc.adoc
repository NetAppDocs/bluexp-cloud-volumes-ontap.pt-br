...
NOTE: A implantação direta do Azure Marketplace suporta os tipos de instância L8s_v3. No entanto, o BlueXP  não oferece suporte a esse tipo de instância para configurações de HA e não poderá detectá-lo corretamente durante a descoberta.
